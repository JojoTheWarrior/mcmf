...
// assumes subdivision stored inside a DCEL, outer face numbered -1
// (1, i) returned if point i lies inside face i, (0, i) returned if point i lies on edge i
...
// example of how to initialize a DCEL
DCEL make_square(pt A, pt B, pt C, pt D) {
    // A, B, C, D must be counterclockwise.
    DCEL dcel;

    using E = DCEL::Edge;

    // Interior-facing half-edges, counterclockwise.
    E* AB = new E{A, nullptr, nullptr,  0};
    E* BC = new E{B, nullptr, nullptr,  0};
    E* CD = new E{C, nullptr, nullptr,  0};
    E* DA = new E{D, nullptr, nullptr,  0};

    // Their twins, which border the outer face.
    E* BA = new E{B, nullptr, AB, -1};
    E* CB = new E{C, nullptr, BC, -1};
    E* DC = new E{D, nullptr, CD, -1};
    E* AD = new E{A, nullptr, DA, -1};
    ...
    // Walk counterclockwise around the interior face.
    AB->nxt = BC;
    BC->nxt = CD;
    CD->nxt = DA;
    DA->nxt = AB;

    // Walk clockwise around the outer face.
    BA->nxt = AD;
    AD->nxt = DC;
    DC->nxt = CB;
    CB->nxt = BA;
